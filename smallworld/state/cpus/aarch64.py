...
class AArch64(cpu.CPU):
    ...
    def __init__(self):
        ...
        self.add(self.x11)
        self.w11 = state.RegisterAlias("w11", self.x11, 4, 0)
        self.add(self.w11)
        self.x12 = state.Register("x12", 8)
        self.add(self.x12)
        self.w12 = state.RegisterAlias("w12", self.x12, 4, 0)
        self.add(self.w12)
        ...
        self.add(self.x21)
        self.w21 = state.RegisterAlias("w21", self.x21, 4, 0)
        self.add(self.w21)
        self.x22 = state.Register("x22", 8)
        self.add(self.x22)
        self.w22 = state.RegisterAlias("w22", self.x22, 4, 0)
        self.add(self.w22)
