...
class AMD64(cpu.CPU):
    ...
    def __init__(self):
        ...
        self.add(self.zmm0)
        self.ymm0   = state.RegisterAlias("ymm0", self.zmm0, 0, 32)
        self.add(self.ymm0)
        self.xmm0   = state.RegisterAlias("xmm0", self.zmm0, 0, 16)
        self.add(self.xmm0)
        
        self.zmm1   = state.Register("zmm1", 64)
        self.add(self.zmm1)
        self.ymm1   = state.RegisterAlias("ymm1", self.zmm1, 0, 32)
        self.add(self.ymm1)
        self.xmm1   = state.RegisterAlias("xmm1", self.zmm1, 0, 16)
        self.add(self.xmm1)
        
        self.zmm2   = state.Register("zmm2", 64)
        self.add(self.zmm2)
        self.ymm2   = state.RegisterAlias("ymm2", self.zmm2, 0, 32)
        self.add(self.ymm2)
        self.xmm2   = state.RegisterAlias("xmm2", self.zmm2, 0, 16)
        self.add(self.xmm2)
        
        self.zmm3   = state.Register("zmm3", 64)
        self.add(self.zmm3)
        self.ymm3   = state.RegisterAlias("ymm3", self.zmm3, 0, 32)
        self.add(self.ymm3)
        self.xmm3   = state.RegisterAlias("xmm3", self.zmm3, 0, 16)
        self.add(self.xmm3)
        
        self.zmm4   = state.Register("zmm4", 64)
        self.add(self.zmm4)
        self.ymm4   = state.RegisterAlias("ymm4", self.zmm4, 0, 32)
        self.add(self.ymm4)
        self.xmm4   = state.RegisterAlias("xmm4", self.zmm4, 0, 16)
        self.add(self.xmm4)
        
        self.zmm5   = state.Register("zmm5", 64)
        self.add(self.zmm5)
        self.ymm5   = state.RegisterAlias("ymm5", self.zmm5, 0, 32)
        self.add(self.ymm5)
        self.xmm5   = state.RegisterAlias("xmm5", self.zmm5, 0, 16)
        self.add(self.xmm5)
        
        self.zmm6   = state.Register("zmm6", 64)
        self.add(self.zmm6)
        self.ymm6   = state.RegisterAlias("ymm6", self.zmm6, 0, 32)
        self.add(self.ymm6)
        self.xmm6   = state.RegisterAlias("xmm6", self.zmm6, 0, 16)
        self.add(self.xmm6)
        
        self.zmm7   = state.Register("zmm7", 64)
        self.add(self.zmm7)
        self.ymm7   = state.RegisterAlias("ymm7", self.zmm7, 0, 32)
        self.add(self.ymm7)
        self.xmm7   = state.RegisterAlias("xmm7", self.zmm7, 0, 16)
        self.add(self.xmm7)
        
        self.zmm8   = state.Register("zmm8", 64)
        self.add(self.zmm8)
        self.ymm8   = state.RegisterAlias("ymm8", self.zmm8, 0, 32)
        self.add(self.ymm8)
        self.xmm8   = state.RegisterAlias("xmm8", self.zmm8, 0, 16)
        self.add(self.xmm8)
        
        self.zmm9   = state.Register("zmm9", 64)
        self.add(self.zmm9)
        self.ymm9   = state.RegisterAlias("ymm9", self.zmm9, 0, 32)
        self.add(self.ymm9)
        self.xmm9   = state.RegisterAlias("xmm9", self.zmm9, 0, 16)
        self.add(self.xmm9)
        
        self.zmm10  = state.Register("zmm10", 64)
        self.add(self.zmm10)
        self.ymm10  = state.RegisterAlias("ymm10", self.zmm10, 0, 32)
        self.add(self.ymm10)
        self.xmm10  = state.RegisterAlias("xmm10", self.zmm10, 0, 16)
        self.add(self.xmm10)
        
        self.zmm11  = state.Register("zmm11", 64)
        self.add(self.zmm11)
        self.ymm11  = state.RegisterAlias("ymm11", self.zmm11, 0, 32)
        self.add(self.ymm11)
        self.xmm11  = state.RegisterAlias("xmm11", self.zmm11, 0, 16)
        self.add(self.xmm11)
        
        self.zmm12  = state.Register("zmm12", 64)
        self.add(self.zmm12)
        self.ymm12  = state.RegisterAlias("ymm12", self.zmm12, 0, 32)
        self.add(self.ymm12)
        self.xmm12  = state.RegisterAlias("xmm12", self.zmm12, 0, 16)
        self.add(self.xmm12)
        
        self.zmm13  = state.Register("zmm13", 64)
        self.add(self.zmm13)
        self.ymm13  = state.RegisterAlias("ymm13", self.zmm13, 0, 32)
        self.add(self.ymm13)
        self.xmm13  = state.RegisterAlias("xmm13", self.zmm13, 0, 16)
        self.add(self.xmm13)
        
        self.zmm14  = state.Register("zmm14", 64)
        self.add(self.zmm14)
        self.ymm14  = state.RegisterAlias("ymm14", self.zmm14, 0, 32)
        self.add(self.ymm14)
        self.xmm14  = state.RegisterAlias("xmm14", self.zmm14, 0, 16)
        self.add(self.xmm14)
        
        self.zmm15  = state.Register("zmm15", 64)
        self.add(self.zmm15)
        self.ymm15  = state.RegisterAlias("ymm15", self.zmm15, 0, 32)
        self.add(self.ymm15)
        self.xmm15  = state.RegisterAlias("xmm15", self.zmm15, 0, 16)
        self.add(self.xmm15)
        
        self.zmm16  = state.Register("zmm16", 64)
        self.add(self.zmm16)
        self.ymm16  = state.RegisterAlias("ymm16", self.zmm16, 0, 32)
        self.add(self.ymm16)
        self.xmm16  = state.RegisterAlias("xmm16", self.zmm16, 0, 16)
        self.add(self.xmm16)
        
        self.zmm17  = state.Register("zmm17", 64)
        self.add(self.zmm17)
        self.ymm17  = state.RegisterAlias("ymm17", self.zmm17, 0, 32)
        self.add(self.ymm17)
        self.xmm17  = state.RegisterAlias("xmm17", self.zmm17, 0, 16)
        self.add(self.xmm17)
        
        self.zmm18  = state.Register("zmm18", 64)
        self.add(self.zmm18)
        self.ymm18  = state.RegisterAlias("ymm18", self.zmm18, 0, 32)
        self.add(self.ymm18)
        self.xmm18  = state.RegisterAlias("xmm18", self.zmm18, 0, 16)
        self.add(self.xmm18)
        
        self.zmm19  = state.Register("zmm19", 64)
        self.add(self.zmm19)
        self.ymm19  = state.RegisterAlias("ymm19", self.zmm19, 0, 32)
        self.add(self.ymm19)
        self.xmm19  = state.RegisterAlias("xmm19", self.zmm19, 0, 16)
        self.add(self.xmm19)

        self.zmm20  = state.Register("zmm20", 64)
        self.add(self.zmm20)
        self.ymm20  = state.RegisterAlias("ymm20", self.zmm20, 0, 32)
        self.add(self.ymm20)
        self.xmm20  = state.RegisterAlias("xmm20", self.zmm20, 0, 16)
        self.add(self.xmm20)
        
        self.zmm21  = state.Register("zmm21", 64)
        self.add(self.zmm21)
        self.ymm21  = state.RegisterAlias("ymm21", self.zmm21, 0, 32)
        self.add(self.ymm21)
        self.xmm21  = state.RegisterAlias("xmm21", self.zmm21, 0, 16)
        self.add(self.xmm21)
        
        self.zmm22  = state.Register("zmm22", 64)
        self.add(self.zmm22)
        self.ymm22  = state.RegisterAlias("ymm22", self.zmm22, 0, 32)
        self.add(self.ymm22)
        self.xmm22  = state.RegisterAlias("xmm22", self.zmm22, 0, 16)
        self.add(self.xmm22)
        
        self.zmm23  = state.Register("zmm23", 64)
        self.add(self.zmm23)
        self.ymm23  = state.RegisterAlias("ymm23", self.zmm23, 0, 32)
        self.add(self.ymm23)
        self.xmm23  = state.RegisterAlias("xmm23", self.zmm23, 0, 16)
        self.add(self.xmm23)
        
        self.zmm24  = state.Register("zmm24", 64)
        self.add(self.zmm24)
        self.ymm24  = state.RegisterAlias("ymm24", self.zmm24, 0, 32)
        self.add(self.ymm24)
        self.xmm24  = state.RegisterAlias("xmm24", self.zmm24, 0, 16)
        self.add(self.xmm24)
        
        self.zmm25  = state.Register("zmm25", 64)
        self.add(self.zmm25)
        self.ymm25  = state.RegisterAlias("ymm25", self.zmm25, 0, 32)
        self.add(self.ymm25)
        self.xmm25  = state.RegisterAlias("xmm25", self.zmm25, 0, 16)
        self.add(self.xmm25)
        
        self.zmm26  = state.Register("zmm26", 64)
        self.add(self.zmm26)
        self.ymm26  = state.RegisterAlias("ymm26", self.zmm26, 0, 32)
        self.add(self.ymm26)
        self.xmm26  = state.RegisterAlias("xmm26", self.zmm26, 0, 16)
        self.add(self.xmm26)
        
        self.zmm27  = state.Register("zmm27", 64)
        self.add(self.zmm27)
        self.ymm27  = state.RegisterAlias("ymm27", self.zmm27, 0, 32)
        self.add(self.ymm27)
        self.xmm27  = state.RegisterAlias("xmm27", self.zmm27, 0, 16)
        self.add(self.xmm27)
        
        self.zmm28  = state.Register("zmm28", 64)
        self.add(self.zmm28)
        self.ymm28  = state.RegisterAlias("ymm28", self.zmm28, 0, 32)
        self.add(self.ymm28)
        self.xmm28  = state.RegisterAlias("xmm28", self.zmm28, 0, 16)
        self.add(self.xmm28)
        
        self.zmm29  = state.Register("zmm29", 64)
        self.add(self.zmm29)
        self.ymm29  = state.RegisterAlias("ymm29", self.zmm29, 0, 32)
        self.add(self.ymm29)
        self.xmm29  = state.RegisterAlias("xmm29", self.zmm29, 0, 16)
        self.add(self.xmm29)
        
        self.zmm30  = state.Register("zmm30", 64)
        self.add(self.zmm30)
        self.ymm30  = state.RegisterAlias("ymm30", self.zmm30, 0, 32)
        self.add(self.ymm30)
        self.xmm30  = state.RegisterAlias("xmm30", self.zmm30, 0, 16)
        self.add(self.xmm30)
        
        self.zmm31  = state.Register("zmm31", 64)
        self.add(self.zmm31)
        self.ymm31  = state.RegisterAlias("ymm31", self.zmm31, 0, 32)
        self.add(self.ymm31)
        self.xmm31  = state.RegisterAlias("xmm31", self.zmm31, 0, 16)
        self.add(self.xmm31)
