...
class MIPSCPUState(cpu.CPU):
    ...
    def __init__(self):
        ...
        self.f0 = state.Register("f0", size=4)
        self.f1 = state.Register("f1", size=4)
        self.f2 = state.Register("f2", size=4)
        self.f3 = state.Register("f3", size=4)
        self.f4 = state.Register("f4", size=4)
        self.f5 = state.Register("f5", size=4)
        self.f6 = state.Register("f6", size=4)
        self.f7 = state.Register("f7", size=4)
        self.f8 = state.Register("f8", size=4)
        self.f9 = state.Register("f9", size=4)
        self.f10 = state.Register("f10", size=4)
        self.f11 = state.Register("f11", size=4)
        self.f12 = state.Register("f12", size=4)
        self.f13 = state.Register("f13", size=4)
        self.f14 = state.Register("f14", size=4)
        self.f15 = state.Register("f15", size=4)
        self.f16 = state.Register("f16", size=4)
        self.f17 = state.Register("f17", size=4)
        self.f18 = state.Register("f18", size=4)
        self.f19 = state.Register("f19", size=4)
        self.f20 = state.Register("f20", size=4)
        self.f21 = state.Register("f21", size=4)
        self.f22 = state.Register("f22", size=4)
        self.f23 = state.Register("f23", size=4)
        self.f24 = state.Register("f24", size=4)
        self.f25 = state.Register("f25", size=4)
        self.f26 = state.Register("f26", size=4)
        self.f27 = state.Register("f27", size=4)
        self.f28 = state.Register("f28", size=4)
        self.f29 = state.Register("f29", size=4)
        self.f30 = state.Register("f30", size=4)
        self.f31 = state.Register("f31", size=4)
