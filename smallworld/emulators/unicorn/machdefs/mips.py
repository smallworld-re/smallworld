...
class MIPSMachineDef(UnicornMachineDef):
    ...
    def __init__(self):
        self._registers = {
            ...
            "f0":   (unicorn.mips_const.UC_MIPS_REG_F0, "f0", 0, 4),
            "f1":   (unicorn.mips_const.UC_MIPS_REG_F1, "f1", 0, 4),
            "f2":   (unicorn.mips_const.UC_MIPS_REG_F2, "f2", 0, 4),
            "f3":   (unicorn.mips_const.UC_MIPS_REG_F3, "f3", 0, 4),
            "f4":   (unicorn.mips_const.UC_MIPS_REG_F4, "f4", 0, 4),
            "f5":   (unicorn.mips_const.UC_MIPS_REG_F5, "f5", 0, 4),
            "f6":   (unicorn.mips_const.UC_MIPS_REG_F6, "f6", 0, 4),
            "f7":   (unicorn.mips_const.UC_MIPS_REG_F7, "f7", 0, 4),
            "f8":   (unicorn.mips_const.UC_MIPS_REG_F8, "f8", 0, 4),
            "f9":   (unicorn.mips_const.UC_MIPS_REG_F9, "f9", 0, 4),
            "f10":  (unicorn.mips_const.UC_MIPS_REG_F10, "f10", 0, 4),
            "f11":  (unicorn.mips_const.UC_MIPS_REG_F11, "f11", 0, 4),
            "f12":  (unicorn.mips_const.UC_MIPS_REG_F12, "f12", 0, 4),
            "f13":  (unicorn.mips_const.UC_MIPS_REG_F13, "f13", 0, 4),
            "f14":  (unicorn.mips_const.UC_MIPS_REG_F14, "f14", 0, 4),
            "f15":  (unicorn.mips_const.UC_MIPS_REG_F15, "f15", 0, 4),
            "f16":  (unicorn.mips_const.UC_MIPS_REG_F16, "f16", 0, 4),
            "f17":  (unicorn.mips_const.UC_MIPS_REG_F17, "f17", 0, 4),
            "f18":  (unicorn.mips_const.UC_MIPS_REG_F18, "f18", 0, 4),
            "f19":  (unicorn.mips_const.UC_MIPS_REG_F19, "f19", 0, 4),
            "f20":  (unicorn.mips_const.UC_MIPS_REG_F20, "f20", 0, 4),
            "f21":  (unicorn.mips_const.UC_MIPS_REG_F21, "f21", 0, 4),
            "f22":  (unicorn.mips_const.UC_MIPS_REG_F22, "f22", 0, 4),
            "f23":  (unicorn.mips_const.UC_MIPS_REG_F23, "f23", 0, 4),
            "f24":  (unicorn.mips_const.UC_MIPS_REG_F24, "f24", 0, 4),
            "f25":  (unicorn.mips_const.UC_MIPS_REG_F25, "f25", 0, 4),
            "f26":  (unicorn.mips_const.UC_MIPS_REG_F26, "f26", 0, 4),
            "f27":  (unicorn.mips_const.UC_MIPS_REG_F27, "f27", 0, 4),
            "f28":  (unicorn.mips_const.UC_MIPS_REG_F28, "f28", 0, 4),
            "f29":  (unicorn.mips_const.UC_MIPS_REG_F29, "f29", 0, 4),
            "f30":  (unicorn.mips_const.UC_MIPS_REG_F30, "f30", 0, 4),
            "f31":  (unicorn.mips_const.UC_MIPS_REG_F31, "f31", 0, 4),
...
class MIPSELMachineDef(MIPSMachineDef):
    ...
    def __init__(self):
        ...
        self._registers.update({
            ...
            "ac0": (unicorn.mips_const.UC_MIPS_REG_AC0, "ac0", 0, 8),
            "lo0": (unicorn.mips_const.UC_MIPS_REG_LO0, "ac0", 0, 4),
            "hi0": (unicorn.mips_const.UC_MIPS_REG_HI0, "ac0", 4, 4),
            "ac1": (unicorn.mips_const.UC_MIPS_REG_AC1, "ac1", 0, 8),
            "lo1": (unicorn.mips_const.UC_MIPS_REG_LO1, "ac1", 0, 4),
            "hi1": (unicorn.mips_const.UC_MIPS_REG_HI1, "ac1", 4, 4),
            "ac2": (unicorn.mips_const.UC_MIPS_REG_AC2, "ac2", 0, 8),
            "lo2": (unicorn.mips_const.UC_MIPS_REG_LO2, "ac2", 0, 4),
            "hi2": (unicorn.mips_const.UC_MIPS_REG_HI2, "ac2", 4, 4),
            "ac3": (unicorn.mips_const.UC_MIPS_REG_AC3, "ac3", 0, 8),
            "lo3": (unicorn.mips_const.UC_MIPS_REG_LO3, "ac3", 0, 4),
            "hi3": (unicorn.mips_const.UC_MIPS_REG_HI3, "ac3", 4, 4),
        })
...
class MIPSBEMachineDef(MIPSMachineDef):
    ...
    def __init__(self):
        ...
        self._registers.update({
            # *** Accumulator Registers ***
            "ac0": (unicorn.mips_const.UC_MIPS_REG_AC0, "ac0", 0, 8),
            "hi0": (unicorn.mips_const.UC_MIPS_REG_HI0, "ac0", 0, 4),
            "lo0": (unicorn.mips_const.UC_MIPS_REG_LO0, "ac0", 4, 4),
            "ac1": (unicorn.mips_const.UC_MIPS_REG_AC1, "ac1", 0, 8),
            "hi1": (unicorn.mips_const.UC_MIPS_REG_HI1, "ac1", 0, 4),
            "lo1": (unicorn.mips_const.UC_MIPS_REG_LO1, "ac1", 4, 4),
            "ac2": (unicorn.mips_const.UC_MIPS_REG_AC2, "ac2", 0, 8),
            "hi2": (unicorn.mips_const.UC_MIPS_REG_HI2, "ac2", 0, 4),
            "lo2": (unicorn.mips_const.UC_MIPS_REG_LO2, "ac2", 4, 4),
            "ac3": (unicorn.mips_const.UC_MIPS_REG_AC3, "ac3", 0, 8),
            "hi3": (unicorn.mips_const.UC_MIPS_REG_HI3, "ac3", 0, 4),
            "lo3": (unicorn.mips_const.UC_MIPS_REG_LO3, "ac3", 4, 4),
        })
