...
class MIPS64MachineDef(UnicornMachineDef):
    ...
    # NOTE: Unicorn only supports the o64 ABI names for registers.
    # We will need to do a little translation
    ...
    def __init__(self):
        self._registers = {
            ...
            "a4": unicorn.mips_const.UC_MIPS_REG_8,
            "8": unicorn.mips_const.UC_MIPS_REG_8,
            "a5": unicorn.mips_const.UC_MIPS_REG_9,
            "9": unicorn.mips_const.UC_MIPS_REG_9,
            "a6": unicorn.mips_const.UC_MIPS_REG_10,
            "10": unicorn.mips_const.UC_MIPS_REG_10,
            "a7": unicorn.mips_const.UC_MIPS_REG_11,
            "11": unicorn.mips_const.UC_MIPS_REG_11,
            # Temporary Registers
            "t0": unicorn.mips_const.UC_MIPS_REG_12,
            "12": unicorn.mips_const.UC_MIPS_REG_12,
            "t1": unicorn.mips_const.UC_MIPS_REG_13,
            "13": unicorn.mips_const.UC_MIPS_REG_13,
            "t2": unicorn.mips_const.UC_MIPS_REG_14,
            "14": unicorn.mips_const.UC_MIPS_REG_14,
            "t3": unicorn.mips_const.UC_MIPS_REG_15,
            "15": unicorn.mips_const.UC_MIPS_REG_15,
            # NOTE: Discontinuity is expected
            # t4 - t7 are sacrificed to make room for a4 - a7
            "t8": unicorn.mips_const.UC_MIPS_REG_24,
            "24": unicorn.mips_const.UC_MIPS_REG_24,
            "t9": unicorn.mips_const.UC_MIPS_REG_25,
