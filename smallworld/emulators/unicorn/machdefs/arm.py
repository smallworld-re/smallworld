        ...
        self._registers.update(
            {
                ...
                "faultmask":    (unicorn.arm_const.UC_ARM_REG_FAULTMASK, "faultmask", 0, 4),
        ...
        self._registers.update(
            {
                ...
                "mvfr0":    (unicorn.arm_const.UC_ARM_REG_MVFR0, "mvfr0", 0, 4),
                "mvfr1":    (unicorn.arm_const.UC_ARM_REG_MVFR1, "mvfr1", 0, 4),
