...
concept. Hints and analyses are described in detail in :ref:`analyses` but the basic
...
be read by a human or consumed by other, higher-level analyses.  
Here, we create a hinter
