...
htmlhelp_basename = "SmallWorlddoc"
...
man_pages = [(master_doc, "smallworld", "SmallWorld Documentation", [author], 1)]
...
autodoc_default_options = {"members": None, "inherited-members": "set, list, dict"}
