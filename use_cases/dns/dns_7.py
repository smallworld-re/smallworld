...
gdata[60] = smallworld.state.IntegerValue(
    2, 1, "buf.a.item.0.text.0.len", byteorder=code.platform.byteorder
)
...
gdata[63] = smallworld.state.IntegerValue(
    0, 1, "buf.a.item.0.text.1.len", byteorder=code.platform.byteorder
)
...
gdata[68] = smallworld.state.IntegerValue(
    2, 1, "buf.b.item.0.text.0.len", byteorder=code.platform.byteorder
)
...
gdata[71] = smallworld.state.IntegerValue(
    0, 1, "buf.b.item.0.text.1.len", byteorder=code.platform.byteorder
)
