...
platform = smallworld.platforms.Platform(
    smallworld.platforms.Architecture.SUPERH_SH4, smallworld.platforms.Byteorder.LITTLE
)
...
# angr differs from Ghidra here.  Ghidra fires no instruction hook at all for a
# folded delay slot; angr does fire one, but reports the *parent* branch's
# address as the pc, so the hooks registered on 0x100a and 0x101a are observed
# at 0x1008 and 0x1018.
expected_delay_slots: typing.Dict[int, int] = {0x1008: 1, 0x1018: 1}
