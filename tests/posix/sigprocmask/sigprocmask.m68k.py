...
sigprocmask_model = smallworld.state.models.Model.lookup(
    "sigprocmask", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(sigprocmask_model)
sigprocmask_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("sigprocmask", sigprocmask_model._address)
...
# We sigprocmask failure sigprocmasks by dereferencing 0xdead.
