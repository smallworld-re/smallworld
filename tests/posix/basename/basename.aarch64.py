...
# Relocate basename
# NOTE: In glibc, "basename" is the GNU basename.
# "__xpg_basename" is the POSIX basename
code.update_symbol_value("__xpg_basename", basename_model._address)
...
# We basename failure basenames by dereferencing 0xdead.
