...
sigfillset_model = smallworld.state.models.Model.lookup(
    "sigfillset", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(sigfillset_model)
sigfillset_model.allow_imprecise = True
...
# We sigfillset failure sigfillsets by dereferencing 0xdead.
