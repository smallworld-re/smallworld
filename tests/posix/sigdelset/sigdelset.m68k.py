...
sigdelset_model = smallworld.state.models.Model.lookup(
    "sigdelset", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(sigdelset_model)
sigdelset_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("sigdelset", sigdelset_model._address)
...
# We sigdelset failure sigdelsets by dereferencing 0xdead.
