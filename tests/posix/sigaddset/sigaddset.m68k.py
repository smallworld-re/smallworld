...
sigaddset_model = smallworld.state.models.Model.lookup(
    "sigaddset", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(sigaddset_model)
sigaddset_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("sigaddset", sigaddset_model._address)
...
# We sigaddset failure sigaddsets by dereferencing 0xdead.
