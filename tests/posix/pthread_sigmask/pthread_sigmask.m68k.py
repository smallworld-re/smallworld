...
pthread_sigmask_model = smallworld.state.models.Model.lookup(
    "pthread_sigmask", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(pthread_sigmask_model)
pthread_sigmask_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("pthread_sigmask", pthread_sigmask_model._address)
...
# We pthread_sigmask failure pthread_sigmasks by dereferencing 0xdead.
