...
sigemptyset_model = smallworld.state.models.Model.lookup(
    "sigemptyset", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(sigemptyset_model)
sigemptyset_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("sigemptyset", sigemptyset_model._address)
...
# We sigemptyset failure sigemptysets by dereferencing 0xdead.
