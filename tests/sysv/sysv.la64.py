...
class Foo(smallworld.state.models.loongarch64.systemv.systemv.LoongArch64SysVModel):
    name = "foo"
...
class Bar(smallworld.state.models.loongarch64.systemv.systemv.LoongArch64SysVModel):
    name = "bar"
    argument_types = [
        smallworld.state.models.cstd.ArgumentType.UINT,
