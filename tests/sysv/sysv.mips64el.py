...
class Foo(smallworld.state.models.mips64el.systemv.systemv.MIPS64ELSysVModel):
    name = "foo"
...
class Bar(smallworld.state.models.mips64el.systemv.systemv.MIPS64ELSysVModel):
    name = "bar"
    argument_types = [
        smallworld.state.models.cstd.ArgumentType.UINT,
