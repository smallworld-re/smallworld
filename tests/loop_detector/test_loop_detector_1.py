...
if __name__ == "__main__":
    ...
    expected(type(hints1[-1]) is LoopHint,
             "found loop hint in hints1",
             "loop hint not found in hints1")
    expected(type(hints2[-1]) is LoopHint,
             "found loop hint in hints2",
             "loop hint not found in hints2")
          
    expected(
        hints1[-1] == LoopHint(message='loop head and strands detected', 
                               head=8722, 
                               strands=[
    ...
    expected(
        hints2[-1] == LoopHint(message='loop head and strands detected',
                               head=8591,
                               strands=[
                                   [8591, 8594, 8597, 8601, 8604, 8607, 8612, 8614, 8616, 8620, 8622, 8625, 8627, 8629, 8631, 8633, 8635, 8637, 8639, 8655, 8658, 8660, 8663, 8665, 8667, 8669, 8672, 8675, 8678, 8682, 8685, 8688, 8690, 8699, 8703, 8706, 8709, 8591],
                                   [8591, 8594, 8597, 8601, 8604, 8607, 8612, 8614, 8616, 8620, 8622, 8625, 8627, 8629, 8631, 8633, 8635, 8637, 8639, 8641, 8644, 8646, 8648, 8650, 8653, 8672, 8675, 8678, 8682, 8685, 8688, 8690, 8699, 8703, 8706, 8709, 8591],
                                   [8591, 8594, 8597, 8601, 8604, 8607, 8612, 8614, 8616, 8620, 8622, 8625, 8627, 8629, 8631, 8633, 8635, 8637, 8639, 8641, 8644, 8646, 8648, 8650, 8653, 8672, 8675, 8678, 8682, 8685, 8688, 8690, 8692, 8699, 8703, 8706, 8709, 8591]
                               ]
                               ),
