...
putc_model = smallworld.state.models.Model.lookup(
    "putc", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(putc_model)
putc_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("putc", putc_model._address)
...
# We signal failure putcs by dereferencing 0xdead.
