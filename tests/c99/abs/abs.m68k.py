...
abs_model = smallworld.state.models.Model.lookup(
    "abs", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(abs_model)
abs_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("abs", abs_model._address)
