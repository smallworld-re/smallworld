...
getchar_model = smallworld.state.models.Model.lookup(
    "getchar", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(getchar_model)
getchar_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("getchar", getchar_model._address)
...
# We signal failure getchars by dereferencing 0xdead.
