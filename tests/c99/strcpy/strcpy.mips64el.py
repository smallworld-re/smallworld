...
strcpy_modell = smallworld.state.models.Model.lookup(
    "strcpy", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(strcpy_modell)

# Relocate puts
code.update_symbol_value("strcpy", strcpy_modell._address)
