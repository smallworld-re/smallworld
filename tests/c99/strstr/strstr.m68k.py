...
strstr_model = smallworld.state.models.Model.lookup(
    "strstr", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(strstr_model)
strstr_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("strstr", strstr_model._address)
...
# We signal failure strstrs by dereferencing 0xdead.
