...
system_model = smallworld.state.models.Model.lookup(
    "system", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(system_model)
system_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("system", system_model._address)
...
# We signal failure systems by dereferencing 0xdead.
