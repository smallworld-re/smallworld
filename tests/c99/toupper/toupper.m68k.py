...
toupper_model = smallworld.state.models.Model.lookup(
    "toupper", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(toupper_model)
toupper_model.allow_imprecise = True
toupper_model.static_buffer_address = heap.address

# Relocate puts
code.update_symbol_value("toupper", toupper_model._address)
...
# We signal failure touppers by dereferencing 0xdead.
