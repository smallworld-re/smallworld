...
atexit_model = smallworld.state.models.Model.lookup(
    "atexit", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
...
# We signal failure atexits by dereferencing 0xdead.
