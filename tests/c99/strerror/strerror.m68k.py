...
strerror_model = smallworld.state.models.Model.lookup(
    "strerror", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
strerror_model.static_buffer_address = 0x20000
machine.add(strerror_model)
strerror_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("strerror", strerror_model._address)
