...
difftime_model = smallworld.state.models.Model.lookup(
    "difftime", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(difftime_model)
difftime_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("difftime", difftime_model._address)
