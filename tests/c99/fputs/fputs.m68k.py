...
fputs_model = smallworld.state.models.Model.lookup(
    "fputs", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(fputs_model)
fputs_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("fputs", fputs_model._address)
...
# We signal failure fputss by dereferencing 0xdead.
