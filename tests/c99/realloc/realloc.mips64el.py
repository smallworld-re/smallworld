...
# FIXME: There's a bug in lief that makes this not work.
#
# For some benighted reason, lief doesn't pick up
# the relocation responsible for populating the function pointer
quit(0)
...
# We signal failure reallocs by dereferencing 0xdead.
