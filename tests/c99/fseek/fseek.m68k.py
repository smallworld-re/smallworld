...
fseek_model = smallworld.state.models.Model.lookup(
    "fseek", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(fseek_model)
fseek_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("fseek", fseek_model._address)
...
# We signal failure fseeks by dereferencing 0xdead.
