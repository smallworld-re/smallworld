...
memmove_model = smallworld.state.models.Model.lookup(
    "memmove", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(memmove_model)
memmove_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("memmove", memmove_model._address)
