...
ungetc_model = smallworld.state.models.Model.lookup(
    "ungetc", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
...
fread_model = smallworld.state.models.Model.lookup(
    "fread", platform, smallworld.platforms.ABI.SYSTEMV, 0x1000C
)
...
fdmgr.model_fs = True
fdmgr.add_file("/tmp/foobar", b"foobar")
...
# We signal failure ungetcs by dereferencing 0xdead.
