...
tmpfile_model = smallworld.state.models.Model.lookup(
    "tmpfile", platform, smallworld.platforms.ABI.SYSTEMV, 0x10000
)
machine.add(tmpfile_model)
tmpfile_model.allow_imprecise = True

# Relocate puts
code.update_symbol_value("tmpfile", tmpfile_model._address)
...
# We signal failure tmpfiles by dereferencing 0xdead.
