...
from harness.framework import run_cases, stable_shards, summaries_json
...
def main() -> int:
    ...
    cases = [case for case in all_cases() if _matches(case.id, case.tags, ns.filter)]
    ...
    return run_cases(cases, verbose=ns.verbose)
