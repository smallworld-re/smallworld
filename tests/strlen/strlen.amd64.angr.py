...
code = smallworld.state.memory.code.Executable.from_filepath("strlen.amd64.bin", address=0x1000)
machine.add(code)
...
# FIXME: Magic number, since we're fighting the auto-alignment
saddr = stack.get_pointer() + 16
