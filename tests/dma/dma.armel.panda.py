...
def func(emulator):
    ...
    print(pc)
    print(emulator.read_memory(pc, 4).hex())
    print("H")


emulator.hook_instruction(0x1000, func)
emulator.hook_instruction(0x1004, func)
emulator.hook_instruction(0x1008, func)
emulator.hook_instruction(0x100C, func)
