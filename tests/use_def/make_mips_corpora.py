...
n64 names llvm-mc assembles) and verified against ``analyze_bytes`` under
MIPS:BE:64:default.

Usage:
  python tests/use_def/make_mips_corpora.py         # regenerate the 3 files
"""
...
# hand-written from the ISA and verified against analyze_bytes.
DWORD_ENTRIES = [
    _entry(
        "daddu $a0, $a1, $a2",
        "00a6202d",
