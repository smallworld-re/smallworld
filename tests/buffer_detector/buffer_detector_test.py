...
def test(hinter, num_insn, buflen, create_heap, fortytwos, randomize_regs, ind, seed):
    global hints
    ...
    hinter.register(BufferDetectionHint, collect_hints)
    # hinter.register(LoopHint, collect_hints)
    c = Colorizer(hinter, num_insns=num_insns, ind)
    cs = ColorizerSummary(
...
if __name__ == "__main__":
    ...
    test(hinter, 200, 40, True, True, True, 0, 1234)
    test(hinter, 200, 47, True, True, True, 1, 1234)
